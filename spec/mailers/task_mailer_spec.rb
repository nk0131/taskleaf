...
describe TaskMailer, type: :mailer do
    let(:task) { FactorBot.create(:task, name: 'メイラーspecを書く', description: '送信したメールの内容を確認します') }
    ...
    describe '#creation_email' do
        ...
        it '想定どおりのメールが生成されている' do
            ...
            expect(mail.to).to eq('kitahara@los-provide.com')
            expect(mail.from).to eq('kitahara@los-provide.com')
